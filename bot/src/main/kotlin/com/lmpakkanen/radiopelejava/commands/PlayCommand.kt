...
import com.lmpakkanen.radiopelejava.models.messages.embeds.SongAddedEmbed
...
class PlayCommand(
    ...
    ICommandListener {
    override val commandName = "play"
    override val commandDescription = "Play song from a given URL or resume playback if paused."
