...
internal class TrackInfoTest {
  ...
  private fun createEntry(
    durationMs: Long, @NonNull expectedDurationString: String
  ): AbstractMap.SimpleEntry<Long, String> {
    return AbstractMap.SimpleEntry<Long, String>(durationMs, expectedDurationString)
  }
